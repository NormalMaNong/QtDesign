...
void MasterView::goDepartmentEditView()
{
    departmentEditView = new DepartmentEditView(this);
...
void MasterView::goDepartmentView()
{
    ...
    connect(departmentView, SIGNAL(goDepartmentEditView()), this, SLOT(goDepartmentEditView()));
}
